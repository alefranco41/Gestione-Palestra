...
def reset_training_info():
    ...
    print(palestra_models.PersonalTraining.objects.all())
    print(management_models.GroupTraining.objects.all())
    ...
    with transaction.atomic():
        ...
        for group_training in all_group_trainings:
            group_training.refresh_from_db()
        ...
        for personal_training in all_personal_training:
            personal_training.refresh_from_db()
